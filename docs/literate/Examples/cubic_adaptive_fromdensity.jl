...
#md save("cubic-density-convergence.svg", convergence_fig); nothing # hide
...
#md save("cubic-density.svg", density_fig); nothing # hide
...
#md save("cubic-density-terms.svg", terms_fig); nothing # hide
